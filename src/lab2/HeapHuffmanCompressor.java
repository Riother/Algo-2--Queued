...
public class HeapHuffmanCompressor {
	
	public HeapHuffmanCompressor() {
	}
	

	public byte[] compress(HeapHuffmanTree tree, byte[] bytes) {
	...
	public byte[] decompress(HeapHuffmanTree tree, int uncompressedLength, byte[] bytes) {
